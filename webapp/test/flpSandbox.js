		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Quotation Interface",
									"targetURL": "#quotationinterface-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"quotationinterface-display": {
								"semanticObject": "quotationinterface",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=quotationinterface",
									"url": sap.ui.require.toUrl("quotationinterface")
								}
							}
						}
					}
